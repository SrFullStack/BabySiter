    ...
    public class RequsetSearchBabysiterRepository : IRequsetSearchBabysiterRepository
    {
        ...
        public async Task GetEmail(string email,string phone)
        {
            using (SmtpClient client = new SmtpClient()
            {
                ...
                Credentials = new NetworkCredential("s6783325@outlook.co.il", "ARH0556783325"), // you must give a full email address for authentication 
            ...
            })
            {
                ...
                {
                    From = new MailAddress("s6783325@outlook.co.il"), // sender must be a full email address
